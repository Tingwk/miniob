...
//   index_file_header.attr_types.push_back(AttrType::INTS);
//   index_file_header.off_and_sizes.push_back({0,4});
...
//   std::vector<pair<int,int>> v{{0,4}};
//   std::vector<AttrType> types{AttrType::INTS};
...
//   key_comparator.init(index_file_header.attr_types, index_file_header.off_and_sizes , 4);
